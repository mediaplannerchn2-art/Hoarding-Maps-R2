# Excel to Exact GPS Site Map - MapLibre GL JS Edition

A fully static HTML + JavaScript version of the Excel OOH map tool, using MapLibre GL JS as the open-source map renderer.
...
- Uses open-source MapLibre GL JS with exact Web-Mercator projection for GPS anchor placement.
...
- Map rendering uses MapLibre GL JS loaded from unpkg.
- The MapLibre raster style loads tiles directly from OpenStreetMap when the user generates a map.
